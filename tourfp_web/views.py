...
def web_index(request):
    ...
    t = get_template('nindex.html')
    #html = t.render(RequestContext(request))
    #return HttpResponse(html)
    return render_to_response("nindex.html",template_var,context_instance=RequestContext(request))
...
def web_reg(request):
    ...
    return render_to_response("nreg.html", template_var, context_instance=RequestContext(request))
...
def web_login(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(reverse("index"))
    template_var["form"] = form        
    return render_to_response("nlogin.html", template_var, context_instance=RequestContext(request))
...
# 地图主界面
def webShowmap(request):
    template_var = {}
    return render_to_response("nmap.html",template_var,context_instance=RequestContext(request))
